...
export const constantRouterMap = [
  ...
  // 会议记录
  {
    ...
    children: [
      ...
      { path: '/confrecord/validating', meta: { title: '待审核会议' }, name: 'validating', component: () => import('@/views/record/validating') },
      { path: '/confrecord/validated', meta: { title: '审核通过会议' }, name: 'validated', component: () => import('@/views/record/validated') }
    ]
  },
