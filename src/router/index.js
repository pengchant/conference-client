...
export const constantRouterMap = [
  ...
  // 会议记录
  {
    ...
    children: [
      ...
      { path: '/confrecord/validating', meta: { title: '待审核会议记录' }, name: 'validating', component: () => import('@/views/record/validating') },
      { path: '/confrecord/validated', meta: { title: '审核通过会议记录' }, name: 'validated', component: () => import('@/views/record/validated') }
    ]
  },
  ...
  // 系统功能配置
  {
    ...
    children: [
      ...
      { path: '/sys/conflevel', meta: { title: '会议等级管理' }, name: 'conflevel', component: () => import('@/views/sysdirectory/conflevel/index') },
